...
const ImpressumPage: React.FunctionComponent<ImpressumPageProps> = () => {
  return (
    <>
      <Helmet bodyAttributes={{ class: "impressum dark" }}>
        <meta name="robots" content="noindex" />
      </Helmet>
      <Head title="Impressum" url="/impressum" />
