...
export const Section = forwardRef<HTMLElement, ContainerProps>((props, ref) => {
  ...
  return (
    <section
      className={cn(
        [
          `group/section relative mx-auto flex max-w-screen-md scroll-m-12 flex-col items-start gap-6 border-t border-t-black/20 px-6 pb-24 pt-6 max-sm:pb-10 lg:px-0`,
