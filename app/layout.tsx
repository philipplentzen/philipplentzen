...
const Layout = ({ children }: NextLayout) => {
	return (
		<html className={`pl-scroll-smooth pl-bg-white pl-bg-grain pl-text-black selection:pl-bg-yellow selection:pl-text-cyan`} lang={`de`}>
			<body className={`pl-flow-root pl-min-h-full pl-leading-4 pl-text-black`}>
				...
				<main className={`pl-relative pl-min-h-screen pl-w-screen pl-pt-30`}>
					<Image src={`/images/clouds.png`} alt={``} width={1920} height={967} sizes={`100vw`} className={`pl-pointer-events-none pl-absolute -pl-left-2/4 pl-top-0 pl-z-10 pl-w-[200%] pl-max-w-none md:pl-left-0 md:pl-w-full xl:pl-top-0`} priority />
					{children}
				</main>
