		...
		<>
			<section className={`pl-relative pl-h-screen supports-ios:pl-h-[100svh] pl-flow-root pl-bg-gradient-to-b pl-from-cyan/20 pl-to-transparent`}>
				<div className={`pl-relative pl-max-w-screen-xl pl-mx-auto pl-mt-[18rem] lg:pl-mt-[15rem] xl:pl-mt-[24rem] pl-px-6 lg:pl-px-0`}>
					<div className={`pl-w-10/12 lg:pl-w-8/12 pl-mx-auto pl-h-12 md:pl-h-24 pl-flow-root`}>
						<div className={`pl-mt-[-3.8%]`}>
							<LogoBig className={``} />
						</div>
					</div>
					<div className={`pl-w-4/12 sm:pl-w-3/12 lg:pl-w-2/12 pl-mx-auto pl-mt-6 lg:pl-mt-12 pl-flex`}>
