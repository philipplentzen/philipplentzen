...
const Impressum: NextPage = () => {
	return (
		<>
			<Link href={`/`}>
				<Logo title={`Philipp Lentzen`} className={`md:pl-w-6/12 pl-mb-6`} />
			</Link>
			<article className={`pl-prose`}>
				...
				<p>
					Philipp Lentzen <br/>
					Kahlgrachtstraße 7 <br/>
					52080 Aachen
				</p>
				<h2>Kontakt</h2>
				<p>
					Telefon: +49 (0) 157 34511197<br/>
					E-Mail: <a href="mailto:kontakt@philipplentzen.dev">kontakt@philipplentzen.dev</a>
				</p>
