...
const Home = () => {
	return (
		<>
			<section className={`pl-relative pl-h-screen supports-ios:pl-h-[100svh] pl-flow-root pl-bg-gradient-to-b pl-from-cyan/20 pl-to-transparent pl-overflow-y-hidden`}>
